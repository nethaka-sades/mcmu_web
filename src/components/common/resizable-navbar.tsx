...
import { HoveredLink, MenuItem } from "./navbar-menu";
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-neutral-950/70",
        className
      )}
    >
      {children}
      ...
      {items.map((item, idx) => (
        ...
        >
          {/*{hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-md opacity-5 bg-gray-100 dark:bg-neutral-950"
            />
          )}*/}
...
export const NavbarLogo = () => {
  return (
    <Link
      href="/"
      className="relative z-20 mr-10 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black"
    >
